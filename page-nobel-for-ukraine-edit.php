<?php
/*
Template Name: Page "Nobel For Ukraine"
*/
?>
...
<main class="main">
	<section class="title">
		<div class="title__wrap" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/nobel-for-ukraine_bg.jpg);">
			<div class="container">
				<div class="title__suptitle">
				</div>
				<h1 class="title__subtitle">Nobel For Ukraine</h1>
				<p class="title__desc">Join our special program to uncover new skills, experiences, and networks, and apply for prosperous job opportunities.</p>
	...
	<section class="start" id="start">
		<div class="container">
			<h2 class="start__title section-title text-decor big">Are you a Ukrainian displaced by the War?
			<br class="--desktop">	We would like to help
			</h2>

			<p class="start__desc">
				Leaving your home, and having to adapt to another country, <b>
					doesn’t mean you can’t do things that you love
				</b> or find a job that makes you happy and helps you grow.
			</p>

			<p class="start__desc">
				Devastated by Russia’s invasion of Ukraine, and encouraged by the <b>resilience</b> and <b>bravery</b>
				of the
				<b>Ukrainian people</b>, we have created a <b>special online program</b> designed to help you and other
				displaced
				Ukrainian youth, adapt faster to these circumstances, improve your skill set, and apply for prosperous
				job opportunities.
			</p>
	...
	<section class="feed">
		<div class="container">
			<h2 class="feed__title section-title text-decor big">Nobel Reach: Uniting Ukraine with <br class="--desktop"> Donated Laptops for a Brighter Future!
			</h2>

			<p class="start__desc">
				Calling all Ukrainians in need of laptops and organizations looking to make a difference! Through Nobel Reach, 
				we are proud to say that we have already facilitated the donation of 100+ laptops, and this number continues to grow each day. 
				In the wake of the war, many Ukrainians face immense challenges, with safety concerns and exorbitant laptop prices hindering their ability to work, study,
				and communicate. Our mission is to bridge this gap by connecting individuals and organizations willing to donate laptops worldwide. 
				Join us in empowering Ukraine's future, one laptop at a time. Together, we can make a lasting impact and create a brighter tomorrow for those in need.
			</p>
			<p class="start__desc">
				<a href="http://nobelreach.org/" target="_blank" class="date__btn">Learn more</a>
			</p>
...
<style>
	...
	* option{
	...
	._form_element ._row._checkbox-radio{
		display: flex;
	}
		...
		<div class="_form-content">
			<div class="_form_element _x49140690 _full_width _clear first-step">
				<div class="sign__image">
					<img src="<? echo get_template_directory_uri(); ?>/assets/images/nobel-for-ukraine-logo.png" alt="#">
				</div>
